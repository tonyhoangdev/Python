...
URL1 ="https://www.coinexchange.io/api/v1/getmarkets"
URL2 ="https://www.coinexchange.io/api/v1/getmarketsummary?market_id=540"
ORDER_BOOK = "https://www.coinexchange.io/api/v1/getorderbook?market_id=540"
...
if __name__ == '__main__':
    ...
    res = json.loads(get(URL1).read())
    with open("markets.json", 'w') as f_out:
        f_out.write(json.dumps(res, indent=4))
        f_out.close()

    res = json.loads(get(URL2).read())
    with open("summaries.json", 'w') as f_out:
        f_out.write(json.dumps(res, indent=4))
        f_out.close()


    res = json.loads(get(ORDER_BOOK).read())
    with open("orderbook.json", 'w') as f_out:
        f_out.write(json.dumps(res, indent=4))
        f_out.close()
